...
const apiBaseURL = "https://201969281-api-server.glitch.me/api/maths";

function webAPI_getMaths(successCallBack, errorCallBack) {
    $.ajax({
        url: apiBaseURL,
        type: 'GET',
...
function webAPI_getMath(id, successCallBack, errorCallBack) {
    $.ajax({
        url: apiBaseURL + "/" + id,
        type: 'GET',
        contentType: 'text/plain',
